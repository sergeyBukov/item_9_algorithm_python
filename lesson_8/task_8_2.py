...
# !!! нашел винтернете. Принцип кодировки Хаффмана понял. Но написать код сам не смог.
...
# Вывод:
# Введите строку для кодировки: мама мыла раму
# 10 11 10 11 00 10 0110 0111 11 00 0100 11 10 0101
